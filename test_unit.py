...
# and determine if the floyd funtion from the file 'function' is giving the correct results.

# At first the floyd function and the test graphs will be imported.
# The big testing graph with 20x20 matrix will be tested in a separate
# unit.
...
# The next steps import the essential libraries to run the tests.
import unittest
import sys
import os
